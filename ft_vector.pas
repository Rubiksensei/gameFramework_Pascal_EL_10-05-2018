...
implementation
    ...
    //Méthode pour l'addition vectorielle
    procedure vectAdd(vect1, vect2 : vect2D);
    var
        vectAdd: vect2D;
    begin
        ...
        writeLn('La somme des vecteurs A(', vect1.x, ', ', vect1.y, ') et B(', vect2.x, ', ', vect2.y, ') donne (', vectAdd.x, ', ', vectAdd.y, ').');
    end;

    //Méthode pour la soustraction vectorielle
    procedure vectSub(vect1, vect2 : vect2D);
    var
        vectSub: vect2D;
    begin
        ...
        writeLn('La difference des vecteurs A(', vect1.x, ', ', vect1.y, ') et B(', vect2.x, ', ', vect2.y, ') donne (', vectSub.x, ', ', vectSub.y, ').');
    end;

    //Méthode pour la multiplication par un reel
    procedure vectMultInt(vect1: vect2D; i: INTEGER);
    var
        vectMultInt: vect2D;
    begin
        ...
        writeLn('Le produit du vecteur A(', vect1.x, ', ', vect1.y, ') par ', i, ' donne (', vectMultInt.x, ', ', vectMultInt.y, ').');
    end;
    ...
    begin
        ...
        writeLn('Le produit vectoriel des vecteurs A(', vect1.x, ', ', vect1.y, ') et B(', vect2.x, ', ', vect2.y, ') donne (', vectProdVect.x, ', ', vectProdVect.y, ').');
    end;
end.